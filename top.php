...
<body style="overflow-y: scroll;">
    ...
    <div class="row" style="margin:0;margin-top: 10px;">
    	...
    	<div class="col-md-8 col-md-offset-2">
            <table class="table table-bordered table-main pull-left" border="1" style="margin-bottom:1.5%; width:99%;">
                <thead>
                    <tr>
                        <th></th>
                        <?php
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="range" data-id="<?php echo $row['id']?>" name="score[]" class="num pull-left parent-criteria" max="<?php echo $range['max'];?>"  min="<?php echo $range['min'];?>" value="0"  step="0.01"/>
    ...
    <div class="modal-dialog modal-m">
      ...
      <form id="set-score-form">
        ...
        <div class="modal-content">
            ...
            <h4 class=" modal-title d-inline-block" style="font-weight:bold;"> <?php echo  "Final Question And Answer" ?><h4>
            <h4 class="candidate-name-on-modal d-inline-block"></h4>
            </div>
            <div class="modal-body">
                <?php
                $query = sqlSelectReturnQuery1("*","final_sub_criteria","segment ='Final Question And Answer' order by sort ASC");
